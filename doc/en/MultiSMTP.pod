...
Fernholz IT GmbH (L<http://www.fernholz-it.de>) sponsored the "anonymous SMTP" feature. With that feature you can add SMTP servers where no authentication is needed.
