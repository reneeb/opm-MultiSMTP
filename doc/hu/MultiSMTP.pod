...
MultiSMTP - felkészíti az OTOBO keretrendszert több SMTP-kiszolgáló használatára

=head1 LEÍRÁS

Egy szabványos OTOBO telepítés nem képes különböző SMTP-kiszolgálók 
...
Ezt a csomagot Renée Bäcker E<lt>info@perl-services.deE<gt> készítette.
...
A magyar fordítást az OTOBO-megoldások csapata készítette.
